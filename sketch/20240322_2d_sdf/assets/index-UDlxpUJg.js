(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const o of l)if(o.type==="childList")for(const d of o.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&i(d)}).observe(document,{childList:!0,subtree:!0});function e(l){const o={};return l.integrity&&(o.integrity=l.integrity),l.referrerPolicy&&(o.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?o.credentials="include":l.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function i(l){if(l.ep)return;l.ep=!0;const o=e(l);fetch(l.href,o)}})();var W=`#version 300 es
...
}`;function dt(n){const t=document.createElement("style");t.innerHTML=n;const e=document.querySelector("head link[rel=stylesheet], head style");e?document.head.insertBefore(t,e):document.head.appendChild(t)}let S=!1;class k{constructor({parent:t,autoPlace:e=t===void 0,container:i,width:l,title:o="Controls",closeFolders:d=!1,injectStyles:p=!0,touchStyles:x=!0}={}){if(this.parent=t,this.root=t?t.root:this,this.children=[],this.controllers=[],this.folders=[],this._closed=!1,this._hidden=!1,this.domElement=document.createElement("div"),this.domElement.classList.add("lil-gui"),this.$title=document.createElement("div"),this.$title.classList.add("title"),this.$title.setAttribute("role","button"),this.$title.setAttribute("aria-expanded",!0),this.$title.setAttribute("tabindex",0),this.$title.addEventListener("click",()=>this.openAnimated(this._closed)),this.$title.addEventListener("keydown",g=>{(g.code==="Enter"||g.code==="Space")&&(g.preventDefault(),this.$title.click())}),this.$title.addEventListener("touchstart",()=>{},{passive:!0}),this.$children=document.createElement("div"),this.$children.classList.add("children"),this.domElement.appendChild(this.$title),this.domElement.appendChild(this.$children),this.title(o),this.parent){this.parent.children.push(this),this.parent.folders.push(this),this.parent.$children.appendChild(this.domElement);return}this.domElement.classList.add("root"),x&&this.domElement.classList.add("allow-touch-styles"),!S&&p&&(dt(at),S=!0),i?i.appendChild(this.domElement):e&&(this.domElement.classList.add("autoPlace"),document.body.appendChild(this.domElement)),l&&this.domElement.style.setProperty("--width",l+"px"),this._closeFolders=d}add(t,e,i,l,o){if(Object(i)===i)return new rt(this,t,e,i);const d=t[e];switch(typeof d){case"number":return new lt(this,t,e,i,l,o);case"boolean":return new Q(this,t,e);case"string":return new ot(this,t,e);case"function":return new L(this,t,e)}console.error(`gui.add failed
	property:`,e,`
	object:`,t,`
	value:`,d)}addColor(t,e,i=1){return new st(this,t,e,i)}addFolder(t){const e=new k({parent:this,title:t});return this.root._closeFolders&&e.close(),e}load(t,e=!0){return t.controllers&&this.controllers.forEach(i=>{i instanceof L||i._name in t.controllers&&i.load(t.controllers[i._name])}),e&&t.folders&&this.folders.forEach(i=>{i._title in t.folders&&i.load(t.folders[i._title])}),this}save(t=!0){const e={controllers:{},folders:{}};return this.controllers.forEach(i=>{if(!(i instanceof L)){if(i._name in e.controllers)throw new Error(`Cannot save GUI with duplicate property "${i._name}"`);e.controllers[i._name]=i.save()}}),t&&this.folders.forEach(i=>{if(i._title in e.folders)throw new Error(`Cannot save GUI with duplicate folder "${i._title}"`);e.folders[i._title]=i.save()}),e}open(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),this.domElement.classList.toggle("closed",this._closed),this}close(){return this.open(!1)}_setClosed(t){this._closed!==t&&(this._closed=t,this._callOnOpenClose(this))}show(t=!0){return this._hidden=!t,this.domElement.style.display=this._hidden?"none":"",this}hide(){return this.show(!1)}openAnimated(t=!0){return this._setClosed(!t),this.$title.setAttribute("aria-expanded",!this._closed),requestAnimationFrame(()=>{const e=this.$children.clientHeight;this.$children.style.height=e+"px",this.domElement.classList.add("transition");const i=o=>{o.target===this.$children&&(this.$children.style.height="",this.domElement.classList.remove("transition"),this.$children.removeEventListener("transitionend",i))};this.$children.addEventListener("transitionend",i);const l=t?this.$children.scrollHeight:0;this.domElement.classList.toggle("closed",!t),requestAnimationFrame(()=>{this.$children.style.height=l+"px"})}),this}title(t){return this._title=t,this.$title.textContent=t,this}reset(t=!0){return(t?this.controllersRecursive():this.controllers).forEach(i=>i.reset()),this}onChange(t){return this._onChange=t,this}_callOnChange(t){this.parent&&this.parent._callOnChange(t),this._onChange!==void 0&&this._onChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onFinishChange(t){return this._onFinishChange=t,this}_callOnFinishChange(t){this.parent&&this.parent._callOnFinishChange(t),this._onFinishChange!==void 0&&this._onFinishChange.call(this,{object:t.object,property:t.property,value:t.getValue(),controller:t})}onOpenClose(t){return this._onOpenClose=t,this}_callOnOpenClose(t){this.parent&&this.parent._callOnOpenClose(t),this._onOpenClose!==void 0&&this._onOpenClose.call(this,t)}destroy(){this.parent&&(this.parent.children.splice(this.parent.children.indexOf(this),1),this.parent.folders.splice(this.parent.folders.indexOf(this),1)),this.domElement.parentElement&&this.domElement.parentElement.removeChild(this.domElement),Array.from(this.children).forEach(t=>t.destroy())}controllersRecursive(){let t=Array.from(this.controllers);return this.folders.forEach(e=>{t=t.concat(e.controllersRecursive())}),t}foldersRecursive(){let t=Array.from(this.folders);return this.folders.forEach(e=>{t=t.concat(e.foldersRecursive())}),t}}const A=j(),s=q(A),v=new k;let ht=K(s,new Float32Array([-1,-1,0,-1,1,0,1,-1,0,1,-1,0,1,1,0,-1,1,0])),ct=D(s,X,s.VERTEX_SHADER),ut=D(s,W,s.FRAGMENT_SHADER),u=J(s,[ct,ut]),ft=s.getUniformLocation(u,"uTime"),R=s.getUniformLocation(u,"f1"),M=s.getUniformLocation(u,"f2"),V=s.getUniformLocation(u,"f3"),T=s.getUniformLocation(u,"f4"),B=s.getUniformLocation(u,"f5"),H=s.getUniformLocation(u,"i1"),N=s.getUniformLocation(u,"i2"),U=s.getUniformLocation(u,"i3"),pt=s.getUniformLocation(u,"uResolution"),z=s.getUniformLocation(u,"uColor"),F=s.getAttribLocation(u,"position"),O=0;const h={color:{r:1,g:0,b:0},f1:1,f2:1,f3:1,f4:.5,f5:.5,i1:3,i2:3,i3:1,b1:!0};v.addColor(h,"color").onChange(n=>{s.uniform3f(z,n.r,n.g,n.b)});v.add(h,"f1").name("translate").min(0).max(1).step(.01).onChange(n=>{s.uniform1f(R,n)});v.add(h,"f2").name("zoomIn").min(0).max(1).step(.01).onChange(n=>{s.uniform1f(M,n)});v.add(h,"f3").min(0).max(1).step(.01).onChange(n=>{s.uniform1f(V,n)});v.add(h,"f4").name("zoomOut").min(0).max(1).step(.01).onChange(n=>{s.uniform1f(T,n)});v.add(h,"f5").name("radius").min(0).max(1).step(.01).onChange(n=>{s.uniform1f(B,n)});v.add(h,"i1").name("side").min(1).max(8).step(1).onChange(n=>{s.uniform1i(H,n)});v.add(h,"i2").name("cellCount").min(2).max(6).step(1).onChange(n=>{s.uniform1i(N,n)});v.add(h,"i3").min(0).max(100).step(1).onChange(n=>{s.uniform1i(U,n)});const G=()=>{s.clear(s.COLOR_BUFFER_BIT|s.DEPTH_BUFFER_BIT),s.useProgram(u),s.viewport(0,0,A.width,A.height),s.scissor(0,0,A.width,A.height),O===0&&(O++,s.uniform3f(z,1,0,0),s.uniform1f(R,h.f1),s.uniform1f(M,h.f2),s.uniform1f(V,h.f3),s.uniform1f(T,h.f4),s.uniform1f(B,h.f5),s.uniform1i(H,h.i1),s.uniform1i(N,h.i2),s.uniform1i(U,h.i3)),s.uniform1f(ft,performance.now()/1e3),s.uniform2f(pt,A.width,A.height),s.bindBuffer(s.ARRAY_BUFFER,ht),s.vertexAttribPointer(F,3,s.FLOAT,!1,0,0),s.enableVertexAttribArray(F),s.drawArrays(s.TRIANGLES,0,6),requestAnimationFrame(G)};G();
